...
function createCardTrack(albumData) {
    ...
    `<li class="list-style-position-inside container-fluid mb-3 cardHover rounded opacityHover" >
        <div class="row align-items-center">
            <p class="col-1 mb-0 opacity-50">1</p>
            <img class="img-2 col-1 object-fit-cover" src="${currentObject}" alt="">
                <h5 class="col-6 mb-0 lh-1">Titolo</h5>
                <p class="col-2 mb-0 opacity-50">45.826.239</p>
                <div class="col-2  d-flex align-items-center">
                    <svg width="24" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="bg-custom-3 border-custom me-5 border-custom-2" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="mb-0 opacity-50">3:07</p>
                </div>
        </div>
    </li >`;
